...
// Generate crossplane-runtime methodsets (resource.Managed, reference resolvers, etc)
//go:generate env GOFLAGS=-tags=angryjet go run -tags generate github.com/crossplane/crossplane-tools/cmd/angryjet generate-methodsets --header-file=../hack/boilerplate.go.txt ./...
